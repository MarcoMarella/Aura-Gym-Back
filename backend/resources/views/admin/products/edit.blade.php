...
@section('page-subtitle', 'Aggiorna le informazioni del prodotto')
            ...
            <div class="glass-effect rounded-2xl p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        @if($product->image)
                            <div class="mb-4 p-4 rounded-xl bg-dark-hover flex items-center gap-4">
                                <img src="{{ asset($product->image) }}" alt="{{ $product->name }}" class="w-20 h-20 object-cover rounded-lg">
                                <div class="flex-1">
                                    <p class="text-sm font-semibold text-white">Immagine attuale</p>
                                    <p class="text-xs text-gray-400">Carica una nuova immagine per sostituirla</p>
                                </div>
                            </div>
                        @endif
                    ...
                    <div>
                        ...
                        <textarea name="description" 
                                  ...
                                  placeholder="Descrivi il prodotto...">{{ old('description', $product->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
